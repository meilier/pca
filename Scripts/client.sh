...
openssl req -config $CLIENTPATH/openssl.cnf -new -key $CLIENTPATH/certs/account/account.key.pem -out $CLIENTPATH/requests/account/account.csr -passin pass:"123456" -subj '/C=US/ST=California/O=XXXX/OU=XXXX Test/CN=XXXX Test 1'
openssl req -config $CLIENTPATH/openssl.cnf -new -key $CLIENTPATH/certs/tls/tls.key.pem -out $CLIENTPATH/requests/tls/tls.csr -passin pass:"123456" -subj '/C=US/ST=California/O=XXXX/OU=XXXX Test/CN=XXXX Test 1'
